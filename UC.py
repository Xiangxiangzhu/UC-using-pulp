...
# -*- coding: utf-8 -*-
"""
Created on Tue Oct 10 10:13:59 2019
...
system_data_1=np.array([[455,150,8,8,8],
                       [455,150,8,8,8],
                       [130,20,5,5,-5],
                       [130,20,5,5,-5],
                       [162,25,6,6,-6],
...
system_data_2=np.array([[1000,16.19,0.00048,4500,9000,5],
...
# =============================================================================
power_q = pulp.LpVariable.dicts("q", (range(10), range(24),range(NL)), lowBound = 0) 
